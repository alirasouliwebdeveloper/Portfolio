  ...
  return (
    <div className="mb-[4rem] md:mb-[8rem]">
      ...
      <p className="text-[#aaaaaa] font-normal w-[80%] text-[17px] opacity-80">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum minus at
        quae architecto optio magni tempora fugit amet culpa similique saepe
        aspernatur, eius nostrum quas hic exercitationem iste vitae explicabo.
      </p>
    </div>
  );
};
